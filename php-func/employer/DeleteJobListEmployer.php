...
$id = $_GET['id'];
$querysel=$mysqli->query("SELECT * FROM employer_vacancy_profile WHERE id = '$id'");

$list=$querysel->fetch_array();

$query1="DELETE FROM employer_vacancy_profile WHERE id='$id'";
...
document.location.href = "../../pages/employer/manage-joblist.php?delete";
</script>';   
?>