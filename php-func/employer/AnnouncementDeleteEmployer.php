...
$id = $_GET['id'];
$querysel=$mysqli->query("SELECT * FROM employer_announcement WHERE id = '$id'");

$list=$querysel->fetch_array();

$query1="DELETE FROM employer_announcement WHERE id='$id'";
...
document.location.href = "../../pages/employer/post-announcement.php?delete";
</script>';
?>