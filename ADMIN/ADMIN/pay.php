    ...
    <div class="notika-status-area">
        <div class="container">
            <div class="row">
                ...
                $req_users=mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM `pay`")or die('Error In Session');
                ...
                $req_today=mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM `pay` WHERE date_created = '".date('Y-m-d')."'")or die('Error In Session');
                ...
                $for_review=mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM `pay` WHERE status = 'FOR REVIEW'")or die('Error In Session');
                ...
                $for_payment=mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM `pay` WHERE status = 'FOR PAYMENT'")or die('Error In Session');
                ...
                $for_released=mysqli_query($con, "SELECT COUNT(id) as TOTAL FROM `pay` WHERE status = 'RELEASED'")or die('Error In Session');
                        ...
                        <div class="table-responsive">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        ?>
                                        <a href="print_pdf.php?user_id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print"></span> PRINT</a>
                                       
                                        <a href="PRINT/index.php?name=<?php echo $row['name'] ?>&request=<?php echo $row['request']; ?>&age=<?php echo $row['age']; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print"></span> GET CERT</a>
                                        </td>
