                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>BARANGAY EMPLOYEES</h2>
                            <p>NOTE : Here are all of the registered users who registers within the system</p>
                            <a href="#addemployee" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> CREATE NEW EMPLOYEE</a>
                        ...
                        <div class="table-responsive">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <?php include('edit_employee_modal.php'); ?>
                                    </tr>
                           <?php } ?>         
                                </tbody>
                                <tfoot>
