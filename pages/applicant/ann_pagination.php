<?php
	...
	$query=mysqli_query($conn,"SELECT count(id) FROM `employer_announcement`");
	...
	$nquery=mysqli_query($conn,"select * from `employer_announcement` WHERE status = 'APPROVED'". $limit);
