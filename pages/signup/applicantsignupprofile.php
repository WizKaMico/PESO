...
window.onload = function() {	
	...
	// ---------------
	var $ = new City();
	$.showProvinces("#CurrentProvince");
	$.showCities("#CurrentCity");
                        ...
                        <div class=card-body>
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="a_fname" id="UpdateFirstName" class="form-control" placeholder="Firstname" required="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <label  class="fs-1 mb-1" for="UpdateFirstName">Lastname</label>
                                        <input type="text" name="a_lname" id="UpdateFirstName" class="form-control" placeholder="Lastname" required="">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-floating">
                                        <label class="fs-1 mb-1" for="UpdateFirstName">M.I.</label>
                                        <input type="text" name="a_mname" id="UpdateFirstName" class="form-control" placeholder="M.I." required="">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-floating">
                                        <label class="fs-1 mb-1" for="UpdateFirstName">Suffix</label>
                                        <input type="text" name="a_suffix" id="UpdateFirstName" class="form-control" placeholder="Suffix" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row mt-2">
                                <div class="col-md-6">
                                        ...
                                        <select class="custom-select" id="floatingSelect" name="a_gender" required="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4">
                                            ...
                                            <select name="a_bmonth" id="month" class="form-control" required=""> 
                                        ...
                                        <div class="col-md-4">
                                            <!-- <label for="">Day</label> -->
                                            <select name="a_bdate" id="day" class="form-control" required="">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="a_byear" id="year" class="form-control" required="">
                                ...
                                <div class="col-md-6 mt-2">
                                        ...
                                        <input type="text" name="a_religion" id="UpdateFirstName" class="form-control" placeholder="Religion" required="">
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label class="fs-1 mb-1" for="floatingSelect">Civil Status</label>
                                    <select class="custom-select" id="floatingSelect" name="a_civilstatus" required="">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col-md-6">  
                                    ...
                                    <input type="text" name="a_cbulidno" id="CurrentBuildNo" class="form-control" required="">
                                </div>
                                <div class="col-md-6">
                                    <label class="fs-1 mb-1" for="CurrentStreetName">Street Name</label>
                                    <input type="text" name="a_cstreetname" id="CurrentStreetName" class="form-control" required="">
                                </div>
                            </div>
                            <div class="form-row mt-4">
                                <div class="col-md-3">
                                    <label  class="fs-1 mb-1" for="CurrentCity">City/Municipality</label>
                                    <select name="a_cprovince" class="form-control" id="CurrentProvince" required=""></select>
                                    
                                    <!-- <input type="txt" name="a_ccity" id="CurrentCity" class="form-control"> -->
                                </div>
                                <div class="col-md-6">
                                    <label  class="fs-1 mb-1" for="CurrentProvince">Province</label>
                                    <select name="a_ccity" class="form-control" id="CurrentCity" required=""></select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="a_czipcode" id="CurrentZipCode" class="form-control" required="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="a_contno1" id="UpdateFirstName" class="form-control" required="">
                                </div>
                                <div class="col-md-6">
                                    <label  class="fs-1 mb-1" for="UpdateFirstName">Secondary Number</label>
                                    <input type="text" name="a_contno2" id="UpdateFirstName" class="form-control" required="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
                        ...
                        <div class=card-body>
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="a_occupation" id="ApplicantOccupation" class="form-control">
                                </div>
                                <div class="col-md-6">
                            ...
                            <label><strong>Preferred Work Location</strong></label>
                                <div class="col-md-12">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input type="radio" name="a_work" id="LocalCheck" class="form-check-input" value="Local">
                                                <label class="form-check-label" for="ApplicantLocalCheck">Local</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input type="radio" name="a_work" id="OverseasCheck" class="form-check-input" value="Overseas">
                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="fs-1 mb-1" for="SpecifyOverseas">Specify Country/Countries</label>
