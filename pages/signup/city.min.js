...
this.showProvinces=function(element){var str='<option selected disabled>City/Municipality</option>';for(let i in this.getProvinces()){str+='<option>'+this.p[i]+'</option>'}
this.p=[];document.querySelector(element).innerHTML='';document.querySelector(element).innerHTML=str;this.e=element;return this}
this.showCities=function(province,element){var str='<option selected disabled>Province</option>';var elem='';if((province.indexOf(".")!==-1||province.indexOf("#")!==-1)){elem=province}
