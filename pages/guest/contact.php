				...
				<div class="row justify-content-md-center">
					...
					<div class="col-xl-10 col-sm-10 mb-1">
						...
						<div class="card col-xl-12 col-sm-12 mb-4 shadow">
							...
							<div class="card-body">
								<div style="font-size: 40px" class="text-center font-weight-bold">CONTACT US</div>
								<hr>
								<div class="card border-0 shadow pt-1">
									<div class="card-body">
										<div style="font-size: 25px;" class="text-center font-weight-bold mb-1">Address</div>
								...
								<div class="card border-0 shadow pt-1 mt-3">
									<div class="card-body">
										<div style="font-size: 25px;" class="text-center font-weight-bold mb-1">Telephone</div>
										<div style="font-size: 16px;" class="text-center">
											<div>+63(44) 764-1268</div>
										</div>
									</div>
								</div>
                                <div class="card border-0 shadow pt-1 mt-3">
									<div class="card-body" >
										<div style="font-size: 25px;" class="text-center font-weight-bold mb-1">E-mail Address</div>
										<div style="font-size: 16px;" class="text-center">
											<div>psypeso@bulacan.gov.ph</div>
										</div>
									</div>
								</div>
                                <div class="card border-0 shadow pt-1 mt-3">
									<div class="card-body">
										<div style="font-size: 25px;" class="text-center font-weight-bold mb-1">Facebook Page</div>
										<div style="font-size: 16px;" class="text-center">
											<a href="https://www.facebook.com/PESOBulacanCapitol">https://www.facebook.com/PESOBulacanCapitol</a>
										</div>
									</div>
								</div>
							</div>
