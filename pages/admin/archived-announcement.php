...
<!-- <li class="nav-item">
                        ...
                        <table class="table table-bordered display" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php
                                ...
                                while($row = $result->fetch_assoc()){
                                    ...
                                    $A_DatePosted = $row['time_posted'];
                                    $A_TimePosted = $row['date_posted'];
                                    $A_PostStatus = $row['post_status'];
                                    $A_PostArchived = $row['post_archive'];
                                    
                                    if($A_PostArchived == 'Archived'){
                            ?>
                                ...
                                <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="../../php-func/admin/AnnouncementUpdateFunction.php">
                                                    <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <button onclick="GetDeleteDetails(<?php echo $row['id']; ?>)" class="btn btn-danger btn-block"><i class="fas fa-trash-alt"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <?php include("manage-employer-modal.php"); ?>
