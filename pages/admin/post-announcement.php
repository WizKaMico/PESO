...
<head>
    ...
    if(isset($_GET['add'])){
    echo '<script type="text/javascript">';
    echo 'setTimeout(function () { swal("Successfully Posted!", "You clicked the button!", "success");';
    echo '}, 500);</script>';
    echo "<script>
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body h-100">
                        <?php
                            if(isset($_GET['error'])){
                                if($_GET['error'] == 'emptyfields'){
                                    ...
                                    ';
                                }elseif($_GET['error'] == 'InvalidAnnouncementTitle'){
                                    echo '
                                    <div class="form-group">
                                        <div class="btn btn-danger btn-block">Invalid Title</div>
                                    </div>
                                    ';
                                }
                            }
                            if(isset($_GET['message'])){
                                if($_GET['message'] == 'success'){
                                    echo '
                                    <div class="form-group">
                                        <div class="btn btn-success btn-block">Your Announcemnet has been Posted!</div>
                                    </div>
                                    ';
                                }
                        ...
                        ?>
                        <form action="../../php-func/admin/AdminAnnouncementFunction.php" method="POST">
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" class="form-control" name="AnnouncementTitle" id="SubjectText">
                            </div>
                            <hr>
                            <div class="form-group">
                                <label>Announcement</label>
                                <textarea class="form-control" name="AnnouncementDesc" id="postannouncement_textarea" cols="30" rows="10"></textarea>
                            </div>
                            <div class="d-flex justify-content-end">
                                <div class="col-3">
                                    <button type="submit" class="btn btn-primary btn-block" ><i class="fas fa-fw fa-upload"></i> Post</button>
                                </div>
                            </div>
                        </form>
                    </div>
